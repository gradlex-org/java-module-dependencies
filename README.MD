...
- *Note 2:* Version catalogs are a preview feature in older Gradle 7.x versions, and you might have to enable them via `enableFeaturePreview("VERSION_CATALOGS")` in _settings.gradle(.kts)_.
